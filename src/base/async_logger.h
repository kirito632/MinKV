...
public:
  static constexpr size_t kBufferSize =
      4 * 1024 * 1024; ///< 4MB缓冲区大小，平衡内存使用和I/O效率
 ...
 */
#define LOG_DEBUG                                                              \
  if (minkv::base::AsyncLogger::getLogLevel() <= minkv::base::LogLevel::DEBUG) \
 ...
 */
#define LOG_ERROR                                                              \
  if (minkv::base::AsyncLogger::getLogLevel() <= minkv::base::LogLevel::ERROR) \
