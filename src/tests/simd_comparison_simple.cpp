...
int main() {
    ...
    std::cout << "平均延迟: " << std::fixed << std::setprecision(2) << latency_scalar << " μs" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "平均延迟: " << std::fixed << std::setprecision(2) << latency_simd << " μs" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "| 耗时 | " << duration_scalar / 1000 << " ms | " 
              << duration_simd / 1000 << " ms | " 
              << std::fixed << std::setprecision(1) << (1 - static_cast<double>(duration_simd) / duration_scalar) * 100 << "% |" << std::endl;
    std::cout << "| QPS | " << std::fixed << std::setprecision(0) << qps_scalar << " | " 
              << qps_simd << " | " 
              << std::setprecision(1) << improvement << "% |" << std::endl;
    std::cout << "| 延迟 | " << std::fixed << std::setprecision(2) << latency_scalar << " μs | " 
              << latency_simd << " μs | " 
              << std::setprecision(1) << (1 - latency_simd / latency_scalar) * 100 << "% |" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "实际加速比: " << std::fixed << std::setprecision(2) << speedup << "x" << std::endl;
    std::cout << "效率: " << std::setprecision(1) << (speedup / 8.0 * 100) << "%" << std::endl;
    std::cout << std::endl;
