...
void print_results(std::vector<TestResult>& results) {
    ...
    std::cout << std::left << std::setw(12) << "分片数"
              << std::right << std::setw(12) << "线程数"
              << std::setw(15) << "QPS"
              << std::setw(15) << "耗时(ms)"
              << std::setw(15) << "相对性能"
              << std::setw(10) << "评价" << "\n";
    ...
    for (const auto& r : results) {
        std::cout << std::left << std::setw(12) << r.shard_count
                  << std::right << std::setw(12) << r.thread_count
                  << std::setw(15) << std::fixed << std::setprecision(0) << r.qps
                  << std::setw(15) << std::fixed << std::setprecision(2) << r.duration_ms
                  << std::setw(14) << std::fixed << std::setprecision(2) << r.relative_to_best << "x";
...
int main() {
    ...
    for (const auto& r : results) {
        csv << r.shard_count << ","
            ...
            << std::fixed << std::setprecision(3) << r.relative_to_best << "\n";
    }
    csv.close();
