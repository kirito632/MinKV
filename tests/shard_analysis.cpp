...
// 模拟分片函数
template <typename K> size_t get_shard_index(const K &key, size_t shard_count) {
...
void test_performance() {
  ...
  std::cout << "\n性能指标:\n";
  std::cout << "  平均延迟: " << std::fixed << std::setprecision(2) << avg_ns
            << " ns\n";
  std::cout << "  吞吐量: " << std::setprecision(0) << (1e9 / avg_ns)
            << " ops/s\n";
