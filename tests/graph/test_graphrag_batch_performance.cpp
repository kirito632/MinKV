...
int main() {
    ...
    std::cout << std::left << std::setw(12) << "查询数量"
              << std::setw(20) << "单查询(ms)"
              << std::setw(20) << "批量并发(ms)"
              << std::setw(15) << "加速比"
    ...
    for (int n : query_counts) {
        ...
        std::cout << std::left << std::setw(12) << n
                  << std::setw(20) << std::fixed << std::setprecision(2) << time_single
                  << std::setw(20) << time_batch
                  << std::setw(15) << std::setprecision(2) << speedup
                  << std::setw(20) << std::setprecision(1) << efficiency << std::endl;
    }
