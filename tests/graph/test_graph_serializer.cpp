...
int main() {
  ...
  // Validates: Requirements 2.6, 2.7
  bool p2 =
      rc::check("Property 2: Node 序列化往返 — DeserializeNode(SerializeNode(n)) == n",
                [](const Node &n) {
  ...
  // Validates: Requirements 3.5, 3.6
  bool p3 =
      rc::check("Property 3: Edge 序列化往返 — DeserializeEdge(SerializeEdge(e)) == e",
                [](const Edge &e) {
  ...
  bool p4 = rc::check("Property 4: 邻接表序列化往返 — 反序列化结果与原列表元素集合相同",
