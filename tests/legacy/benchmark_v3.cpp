...
BenchmarkResult benchmark_optimized_sharded(int shard_count) {
  ...
  return {.name = "OptimizedShardedCache(32)",
          .total_ops = total_ops,
          .duration_ms = duration_ms,
          .qps = qps,
          .latency_us = latency_us};
